...
namespace NaughtierAttributes.Editor
{
    public class CodeGenerator : UnityEditor.Editor
    {
        ...
        {
            GenerateScript<BasePropertyMeta, PropertyMetaAttribute>("PropertyMetaDatabase", "PropertyMetaDatabaseTemplate", META_ENTRY_FORMAT);
            GenerateScript<BasePropertyDrawer, PropertyDrawerAttribute>("PropertyDrawerDatabase", "PropertyDrawerDatabaseTemplate", DRAWER_ENTRY_FORMAT);
            GenerateScript<BaseArrayDrawer, ArrayDrawerAttribute>("ArrayDrawerDatabase", "ArrayDrawerDatabaseTemplate", DRAWER_ENTRY_FORMAT);
            GenerateScript<BaseDecoratorDrawer, DecoratorDrawerAttribute>("DecoratorDrawerDatabase", "DecoratorDrawerDatabaseTemplate", DRAWER_ENTRY_FORMAT);
            GenerateScript<BaseClassDrawer, ClassDrawerAttribute>("ClassDrawerDatabase", "ClassDrawerDatabaseTemplate", DRAWER_ENTRY_FORMAT);
            GenerateScript<BaseElementDecoratorDrawer, ElementDecoratorDrawerAttribute>("ElementDecoratorDrawerDatabase", "ElementDecoratorDrawerDatabaseTemplate", DRAWER_ENTRY_FORMAT);
            GenerateScript<BaseAutoValueDrawer, AutoValueDrawerAttribute>("AutoValueDrawerDatabase", "AutoValueDrawerDatabaseTemplate", DRAWER_ENTRY_FORMAT);
            GenerateScript<BasePropertyGrouper, PropertyGrouperAttribute>("PropertyGrouperDatabase", "PropertyGrouperDatabaseTemplate", GROUPER_ENTRY_FORMAT);
            GenerateScript<BaseConditionalGrouper, ConditionalGrouperAttribute>("ConditionalGrouperDatabase", "ConditionalGrouperDatabaseTemplate", GROUPER_ENTRY_FORMAT);
            GenerateScript<BasePropertyValidator, PropertyValidatorAttribute>("PropertyValidatorDatabase", "PropertyValidatorDatabaseTemplate", VALIDATOR_ENTRY_FORMAT);
            GenerateScript<BasePropertyDrawCondition, PropertyDrawConditionAttribute>("PropertyDrawConditionDatabase", "PropertyDrawConditionDatabaseTemplate", DRAW_CONDITION_ENTRY_FORMAT);

            GenerateScript<BaseFieldDrawer, FieldDrawerAttribute>("FieldDrawerDatabase", "FieldDrawerDatabaseTemplate", DRAWER_ENTRY_FORMAT);
            GenerateScript<BaseMethodDrawer, MethodDrawerAttribute>("MethodDrawerDatabase", "MethodDrawerDatabaseTemplate", DRAWER_ENTRY_FORMAT);
            GenerateScript<BaseNativePropertyDrawer, NativePropertyDrawerAttribute>("NativePropertyDrawerDatabase", "NativePropertyDrawerDbTemplate", DRAWER_ENTRY_FORMAT);
