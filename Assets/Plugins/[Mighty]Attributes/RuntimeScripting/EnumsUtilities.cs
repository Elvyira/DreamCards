...
namespace MightyAttributes
{
    ...
    [Flags]
    public enum SerializableOption : short
    {
        Nothing = 0,
        All = -1,
    ...
    public enum EditorFieldOption : short
    {
        ...
        HideLabel = FieldOption.HideLabel,
        BoldLabel = FieldOption.BoldLabel,
        DontFold = SerializableOption.DontFold,
    ...
    public static class EnumsUtilities
    {
        ...
        public static bool Contains(this SerializableOption option, SerializableOption flag) => (option & flag) != 0;
        public static bool ContainsExact(this SerializableOption option, SerializableOption flag) => (option & flag) == flag;
