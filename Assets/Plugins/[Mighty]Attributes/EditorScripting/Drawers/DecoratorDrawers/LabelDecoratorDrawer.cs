...
namespace MightyAttributes.Editor
{
    ...
    public class LabelDecoratorDrawer : BaseDecoratorDrawer, IDrawAnywhereDecorator, IRefreshDrawer
    {
        ...
        public void DrawLabel(BaseMightyMember mightyMember, LabelAttribute attribute)
        {
            ...
            {
                if (style == null)
                    EditorGUILayout.LabelField(label, GUILayout.Width(EditorDrawUtility.TextLength(label)));
                else
                    EditorGUILayout.LabelField(label, style, GUILayout.Width(EditorDrawUtility.TextLength(label)));
            }
            else
            {
                if (style == null)
