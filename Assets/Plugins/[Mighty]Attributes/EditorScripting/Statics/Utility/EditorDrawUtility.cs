...
namespace MightyAttributes.Editor
{
    ...
    public static class EditorDrawUtility
    {
        ...
        public static bool DrawAddButton() => GUILayout.Button(DrawIcon(IconName.PLUS), GUILayout.Height(30), GUILayout.Width(30));
        public static bool DrawRemoveButton() => GUILayout.Button(DrawIcon(IconName.MINUS), GUILayout.Height(30), GUILayout.Width(30));
